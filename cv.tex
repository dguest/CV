...
\cvcontribentry{2024}{ATLAS Outstanding Achievement Award}{}{}{}{%
  For outstanding contributions to heavy flavor tagging algorithms based on Graph Neural Networks. I was the primary designer and maintainer for the data backbone that supported our most sophisticated taggers.
}
\cvcontribentry{2020--2022}{Signature Coordinator}{$b$-jets}{Trigger Group}{}{%
  ...
  I accomplished this in a few ways. First, I unified the flavor tagging applied in the trigger and that which was applied in subsequent offline analysis. This ensured that our trigger used state-of-the-art algorithms to reject background events and accept signal.
...
\cvcontribentry{2018--2021}{Analysis Contact}{Mono-$H$, $H \to b\bar{b}$}{Exotics Group}{}{%
  I served as one of two analysis contacts for a team of $O(10)$ active contributors.
  This search served as both an interesting probe into BSM physics and as a trial of boosted $H$-tagging using the variable-radius jets I helped develop in \href{https://cds.cern.ch/record/2268678}{ATL-PHYS-PUB-2017-010}.
}
\cvcontribentry{2018--2020}{Convener}{Machine Learning Forum}{Computing Group}{}{%
  Beyond organizing weekly meetings and yearly workshops, I developed central strategies to deploy machine learning models within ATLAS.
  I oversaw the integration of \textsc{ONNXRuntime}, which remains ATLAS's standard tool for ML deployment within the ATLAS trigger and reconstruction environments.
}
\cvcontribentry{2017--2020}{Flavor Tag Contact}{Boosted $H \to b\bar{b}$ Taskforce}{ATLAS Combined Performance}{}{%
  As the contact for this task force, I led the development of boosted $H$-tagging in ATLAS.
  This group later became the Xbb/Xcc subgroup under flavor tagging.
}
\cvcontribentry{Fall~2018}{Taskforce Chair}{Software and Database Review}{Flavor Tagging Group}{}{
  I led a review of the ATLAS flavor tagging software, with a main focus on simplifying structure and dropping unused features.
  This was the first of several major overhauls which I took part in.
}

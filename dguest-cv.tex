...
% character encoding
%\usepackage[utf8]{inputenc}                       % if you are not using latex ou lualatex, replace by the encoding you are using
...
%% \newcommand{\inspiresocialsymbol}{\aiInspire~}
%% The above one doesn't really look like inspire
...
\fancyfoot[C]{\footnotesize
  \url{https://dguest-public.web.cern.ch/dguest-cv-extended.pdf} \\
  Updated: \textit{\today}
}
...
\cventry{2015--2020}{\postdoc}{University of California, Irvine}{Irvine, CA, USA}{}{
  \begin{itemize}
  \item Searched for exotic particles in simplified extensions of the Standard Model. I lead an analysis searching for dark matter produced in association with boosted $H$ jets.
...
\cventry{2026--}{Board Member}{}{Early Career Scientist Board}{}{
...
\cventry{2023--2025}{Convener}{}{Flavor Tagging Group}{}{
  I took charge of the ATLAS flavor tagging group a very interesting time. We had recently demonstrated that a single large transformer model, trained on low level inputs, could outperform a hand-crafted sequence of algorithms designed by experts. \\
...
\cventry{2024}{ATLAS Outstanding Achievement Award}{}{}{}{
...
%%   \item Fabricated optics with vacuum deposition
%%   \end{itemize}
%% }
%% \cventry{2003--2004}{Research Assistant}{Dartmouth Medical School}{Hanover NH, USA}{}{\begin{itemize}
%%   \item Gathered physiological data from lab animals

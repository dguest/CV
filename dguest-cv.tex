...
\social[inspire]{D.Guest.1}   % not sure why this doesn't work right now
%\social[skype]{jdoe}                               % optional, remove / comment the line if not wanted
\extrainfo{\gitlabsocialsymbol\href{https://gitlab.cern.ch/dguest}{dguest}}                 % optional, remove / comment the line if not wanted
%\quote{Some quote}                                 % optional, remove / comment the line if not wanted
\photo[56pt][0pt]{images/DG-sheer.jpg}
...
\cventry{2007}{B.A. Physics}{Amherst College}{Amherst, Massachusetts, USA}{\textit{magna cum laude}}{}
...
\section{Appointments and Awards}
...
\cventry{2025--2026}{Coordinator}{Atlas}{Inter-Experimental LHC Machine Learning Working Group}{}{}
...
\section{Selected Publications, Software, and Data}

\cvitem{2025}{Transforming Jet Flavour Tagging at ATLAS\newline{}
  \texttt{\href{https://doi.org/10.1038/s41467-025-65059-6}{Nature Commun.\ 17 (2026) 541}}, \arxiv{2505.19689}
}
\cvitem{2025}{
  \textsc{JetSet}: Simulated ATLAS $t\bar{t}$ data for ML-based jet flavor tagging.
  \newline{}
  \doi{10.7483/OPENDATA.ATLAS.QG8W.TO8P}
}
\cvitem{2023}{Fast $b$-tagging at the high-level trigger of the ATLAS experiment in LHC Run 3\newline{}

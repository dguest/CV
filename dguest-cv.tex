...
\cvitem{Early 2019}{Search for low-mass resonances decaying into two jets and produced in association with a photon using $pp$ collisions at $s=\sqrt{13}\,\mathrm{TeV}$ with the ATLAS detector\newline{}
\textit{In Preparation for Physics Letters B: }\url{https://cds.cern.ch/record/2652013}}
...
\cventry{Oct 2014}{Software Carpentry}{Yale University}{}{}{Taught practical Bash, Python, and version control for physical sciences}

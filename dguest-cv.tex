...
\fancyfoot[C]{\footnotesize
  \url{https://dguest-public.web.cern.ch/dguest-cv.pdf} \\
  Updated: \textit{\today}
}
...
\cventry{Nov 2020--}{\postdoc}{Humboldt University}{Berlin, DE}{}{
  \begin{itemize}
  \item Searches for $HH$ production in the $b \bar{b} b \bar{b}$ final state
  \item Machine learning for $b$-quark identification
  \end{itemize}
}
\cventry{2020}{\postdoc}{Universit\"{a}t Innsbruk}{Innsbruk, AT}{}{
  Mandate identical to that at Humboldt University
}
\cventry{2015--2020}{\postdoc}{University of California, Irvine}{Irvine, CA, USA}{}{
  \begin{itemize}
  \item Searches for exotic particles in simplified extensions of the Standard Model
  \item Machine learning for LHC physics
  \end{itemize}
}
\cventry{2008--2016}{Ph.D.\ Candidate}{Yale University}{New Haven, Connecticut, USA}{}{
  \begin{itemize}
  \item Searches for Supersymmetry
  \item Algorithm development for $c$-quark identification
  \item ATLAS Transition Radiation Tracker studies
  \item Teaching assistant for undergraduates
  \end{itemize}
}
...
\cventry{2003--2004}{Research Assistant}{Dartmouth Medical School}{Hanover NH, USA}{}{
  \begin{itemize}
  \item Data aquisition via rodent telemetry

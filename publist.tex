...
\newcommand{\cds}[1]{Avaliable from CERN: \url{https://cds.cern.ch/record/#1}}


\section{Selected Publications}
\subsection{Hundreds of published papers as part of the ATLAS Collaboration with over 10,000 citations.}
\cvitem{In Prep}{Deep Sets and Event-Level Maximum-Likelihood Estimation for Fast Pile-Up Jet Rejection\newline{}
  \wip{PUB-TRIG-2025-01}
}
\cvitem{In Prep}{Tau Trigger Run 3 Performance\newline{}
  \wip{ANA-TRIG-2024-01}
}
\cvitem{In Prep}{The GN3 Flavor Tagging Algorithm\newline{}
  \wip{PUB-FTAG-2024-05}
}
